...
const remote=vi.hoisted(()=>({node:{} as RemoteNode,reads:0,writes:0,delay:0,discard:false,reject:false}));
...
beforeEach(async()=>{
 ...
 remote.reads=0;remote.writes=0;remote.delay=0;remote.discard=false;remote.reject=false;vi.mocked(generateCopy).mockClear();
});
