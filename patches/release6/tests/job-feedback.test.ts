...
vi.mock('react-router',()=>({
 ...
 useSearchParams:()=>[new URLSearchParams(),vi.fn()],useFormAction:()=>'/app',useRevalidator:()=>({revalidate:vi.fn()}),Link:({to,children,...props}:{to:string;children:React.ReactNode})=>React.createElement('a',{href:to,...props},children)
}));
