...
export function storeScore(input:ScoreInput){
 ...
 return {version:3,technical,score:raw===null?null:capped?Math.min(55,raw):raw,parts,coverage,capped,limited:parts.some(p=>p.low)||coverage<100,search,readiness,ai,cited,samples:samples.length};
}
