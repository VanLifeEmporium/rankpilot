...
export const operations = {
  ...
  collections: `query Collections($after:String) { collections(first:50,after:$after) { pageInfo { hasNextPage endCursor } nodes { id title handle descriptionHtml updatedAt seo { title description } seoTitle:metafield(namespace:"global",key:"title_tag") { value } seoDescription:metafield(namespace:"global",key:"description_tag") { value } image { id url altText width height } } } }`,
