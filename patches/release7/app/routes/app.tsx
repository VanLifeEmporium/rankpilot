      ...
      {!demo && (
        <s-app-nav>
          {[
            ...
            >
              {({Dashboard:"Overview",Audit:"Find issues",Reviews:"Review & apply",Content:"Blog drafts",AEO:"Help AI answer questions",Reports:"Results & history"} as Record<string,string>)[t] || t}
            </s-link>
          ))}
        </s-app-nav>
      )}
