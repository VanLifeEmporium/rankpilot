        ...
        <main>
          ...
          {section === "reports" && (
            <>
              ...
              <SearchPerformance metrics={d.metrics}/><section className="card">
      ...
      >
        ...
        {factResource && (
          ...
          >
            ...
            <SourceSuggestions key={factResource.id} id={factResource.id} kind={factResource.kind} plan={factResource.plan} busy={busy} onAction={submit}/>
