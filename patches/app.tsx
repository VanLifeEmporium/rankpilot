      ...
      {!demo && (
        <s-app-nav>
          {[
            ...
            >
              {({Dashboard:"Overview",Audit:"Find issues",Reviews:"Review & apply",Content:"Blog drafts",AEO:"FAQs & AI visibility",Reports:"Results & history"} as Record<string,string>)[t] || t}
            </s-link>
          ))}
        </s-app-nav>
      )}
