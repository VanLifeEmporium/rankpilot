...
export default function Workspace() {
  ...
  const factResource = resourceDetail.state==="idle" && resourceDetail.data?.id===factId ? resourceDetail.data : undefined;
        ...
        {factResource && (
          ...
          >
            ...
            <label>
              ...
              <input name="keyword" defaultValue={factResource.keyword||factResource.plan.suggestions.primary} />
            </label>
            ...
            <div className="dialog-actions facts-footer">
              ...
              <button className="button primary" disabled={busy}>{busy ? "Saving…" : factResource.kind==="product"?"Save product details":"Save search phrase"}</button>
            </div>
          </fetcher.Form>
        )}
      </dialog>
