...
it('returns an actionable provider timeout instead of a word-count or running loop',async()=>{
 vi.stubGlobal('fetch',vi.fn().mockRejectedValue(new DOMException('Timed out','TimeoutError')));
 await expect(generateCopy('s',p,'product','seo',{})).rejects.toThrow('No change was made. Try preparing this preview again');
});
