import {opportunityQueries} from '../core/dashboard';
    ...
    <div className="workspace">
      ...
      <div className="main-wrap">
        ...
        <main>
          ...
          {section === "dashboard" && <Dashboard d={d} issues={issues} busy={busy} onGenerate={optimise} onReview={setReviewId}/>}
          {section === "audit" && (
            <>
          ...
          {section === "reports" && (
            <>
              ...
              <section className="card">
                ...
                <div className="table-wrap"><table><thead><tr><th>Search phrase</th><th>Page</th><th>Views in search</th><th>Position</th><th>Click rate</th></tr></thead><tbody>{opportunityQueries(gsc[0]?.rows).slice(0,50).map((r,i)=><tr key={i}><td>{r.keys[1]}</td><td>{r.keys[0]}</td><td>{r.impressions}</td><td>{r.position?.toFixed(1)}</td><td>{r.impressions?(100*r.clicks/r.impressions).toFixed(1):0}%</td></tr>)}</tbody></table></div>
